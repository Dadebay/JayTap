...
class _AddHouseViewState extends State<AddHouseView> {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildSection('Bildirişiň ady', _buildTextField(controller.nameController, 'Meselem: 3 otagly jaý', null)),
          _buildSection('Salgysy', _buildTextField(controller.addressController, 'Meselem: Magtymguly şaýoly, 12-nji jaý', null)),
          _buildSection('Goşmaça maglumat', _buildTextField(controller.descriptionController, 'Jaý hakda giňişleýin maglumat...', null, maxLines: 5)),
      ...
      child: Obx(() {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return Obx(() {
              final isSelected = controller.selectedVillageId.value == village.id;
      ...
      return SizedBox(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return Obx(() {
              final isSelected = controller.selectedInSubCategoryId.value == subCategory.id;
              return GestureDetector(
          ...
          children: [
            Obx(
              () => FlutterMap(
                ...
                options: MapOptions(
                  initialCenter: controller.selectedLocation.value ?? const LatLng(37.95, 58.38),
                  initialZoom: 13.0,
                  onMapReady: () {
  ...
  Widget _buildTextField(TextEditingController c, String hint, String? suffix, {String? prefix, int? maxLines = 1}) {
          ...
          itemBuilder: (context, index) {
            ...
            return Obx(() => GestureDetector(
                  ...
                  child: Container(
                    ...
                    margin: const EdgeInsets.only(right: 8),
                    decoration: BoxDecoration(
                      color: selectedValue.value == number ? Get.theme.primaryColor : Colors.grey[200],
                      borderRadius: BorderRadius.circular(8),
                    ),
                    child: Center(
                      child: Text(
                        number.toString(),
                        style: TextStyle(
                          color: selectedValue.value == number ? Colors.white : Colors.black,
                          fontWeight: FontWeight.bold,
                        ),
                      ),
                    ),
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return _buildIndividualRoomStepper(
                ...
                (change) => c.changeSpecificationCount(specification.id, change),
              );
            },
          ),
  ...
  Widget _buildIndividualRoomStepper(String label, RxInt value, Function(int) onChanged) {
    return Padding(
